...
def data_preparation(training_data_path):
    ...
    Parameters:
    training_data_path (str): Path to the CSV file containing 'sentence' and 'difficulty' columns.
    
    Returns:
    tuple: Transformed training and validation features, training and validation labels, label encoder, and vectorizer.
    """
